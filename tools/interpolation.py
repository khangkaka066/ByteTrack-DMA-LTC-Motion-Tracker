...
if __name__ == '__main__':
    data_root = 'datasets/dancetrack/test'
    txt_path = 'YOLOX_outputs/ltc_dma_dancetrack_test_set/track_results'
    save_path = 'YOLOX_outputs/ltc_dma_dancetrack_test_set/track_results_dti'
